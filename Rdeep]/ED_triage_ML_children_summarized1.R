...
library(haven)
x <- read_sav("e:/dataset/ed2007-spss.sav")
y2007 <- x %>% 
...
x <- read_sav("e:/dataset/ed2008-spss.sav")
y2008 <- x %>% 
  select(AGE,SEX,ARRIVE,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMED,LEFTBMSE,LEFTAMSE,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANSFER)%>%
  filter(AGE<19)
y2008 <- y2008 %>% 
...
x <- read_sav("e:/dataset/ed2009-spss.sav")
y2009 <- x %>% 
...
x <- read_sav("e:/dataset/ed2010-spss.sav")
y2010 <- x %>% 
  ...
  filter(AGE<19)
x <- read_sav("e:/dataset/ed2011-spss.sav")
y2011 <- x %>% 
  select(AGE,SEX,ARREMS,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMEDR,LEFTBTRI,LEFTATRI,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANOTH)%>%
  filter(AGE<19)
x <- read_sav("e:/dataset/ed2012-spss.sav")
y2012 <- x %>% 
  select(AGE,SEX,ARREMS,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMEDR,LEFTBTRI,LEFTATRI,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANOTH)%>%
  filter(AGE<19)
x <- read_sav("e:/dataset/ed2013-spss.sav")
y2013 <- x %>% 
  select(AGE,SEX,ARREMS,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMEDR,LEFTBTRI,LEFTATRI,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANOTH)%>%
  filter(AGE<19)
x <- read_sav("e:/dataset/ed2014-spss.sav")
y2014 <- x %>% 
  select(AGE,SEX,ARREMS,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMEDR,LEFTBTRI,LEFTATRI,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANOTH)%>%
  filter(AGE<19)
x <- read_sav("e:/dataset/ed2015-spss.sav")
y2015 <- x %>% 
  select(AGE,SEX,ARREMS,TEMPF,PULSE,RESPR,BPSYS,BPDIAS,POPCT,SEEN72,RFV1,IMMEDR,LEFTBTRI,LEFTATRI,LEFTAMA,DIEDED,DOA,ADMIT,HDSTAT,ADMITHOS,TRANOTH)%>%
  filter(AGE<19)

mydataset= rbind(y2007,y2008)
names(y2009) = names(mydataset)
mydataset= rbind(mydataset,y2009)
names(y2010) = names(mydataset)
mydataset= rbind(mydataset,y2010)
mydataset= rbind(mydataset,y2011)
mydataset= rbind(mydataset,y2012)
mydataset= rbind(mydataset,y2013)
mydataset= rbind(mydataset,y2014)
mydataset= rbind(mydataset,y2015)
